...
const translations: Record<Language, Translations> = {
  es: {
    ...
    "event.extraNotes": "Notas extra",
    "event.cloakroom": "Hay guardarropa.",
    ...
    "rsvp.confirmBusReturnDetails": "Vuelta a las {time} hacia {location}.",
  ...
  "de-CH": {
    ...
    "event.extraNotes": "Zusätzliche Hinweise",
    "event.cloakroom": "Es git e Garderobe.",
    ...
    "rsvp.confirmBusReturnDetails": "Rückfahrt um {time} nach {location}.",
